...
ctx.fillText("Happy Birthday, Una, Shayna, Arav!", width / 2, height / 2 - 100);
...
function animation() {
    ...
    if (firstFrame < 1401) {
        ...
        ctx.fillStyle = "Red";
        ctx.fillText("Una", 20 + firstFrame, 100);
        ctx.fillStyle = "Orange";
        ctx.fillText("Shayna", 1200 - firstFrame, 200);
        ctx.fillStyle = "Green";
        ctx.fillText("Arav", 20 + firstFrame, 300);
        ctx.fillStyle = "Blue";
        ctx.fillText("Happy Birthday!", 1200 - firstFrame, 400);
    } else if (firstFrame < 1501) {
        ctx.textAlign = "center";
        ctx.font = firstFrame - 1400 + "px Courier";
        ctx.fillStyle = "Black"
        ctx.fillText("And thanks to Mrs. Lahey!", width / 2, height / 2);
    } else {
        spawnConfetti();
